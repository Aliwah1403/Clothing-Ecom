  ...
  slideContainer.innerHTML = `
    <section class="product">
      ...
      <button class="pre-btn">
        <img src="../images/arrow.png" alt="Pre-Arrow" />
      </button>
      <button class="nxt-btn">
        <img src="../images/arrow.png" alt="Post-Arrow" />
      </button>
...
const createProductCards = (data, parent) => {
  // here the parent is for the search product
  let start = '<div class = "product-container">';
  let middle = ''; //this will contain the card HTML
  let end = '</div>';
